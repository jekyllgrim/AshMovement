...
> Note: Like with all custom properties in ZScript, these have to be prefixed with the name of the class, in this case `AM_PlayerPawn.`

| Property name             | Default value | Description                                                                                                                                                                                                                                                                |
| ------------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AccelerationFactor        | 0.2           | How quickly player reaches maximum velocity when they start moving. Represents how much of maximum velocity is reached per tic (default 0.2 = ~5 tics to reach maximum velocity).
Valid values are in [0.01, 1.0] range.                                                   |
| MaxCoyoteTime             | 10            | Duration of coyote time in tics                                                                                                                                                                                                                                            |
...
| WeaponLeanPitchRangeMin   | 0.0           | How far the weapon can be pushed UP by when moving the camera DOWN (has to be <= 0.0; lower value = further up). This is zero by default to avoid potential sprite cutoffs. If there's enough sprite space below the screen or you're using 3D models, make this NEGATIVE. |
| WeaponLeanPitchRangeMax   | 14.0          | How far the weapon can be pushed DOWN by when moving the camera UP (has to be >= 0.0; higher value = further down).                                                                                                                                                        |
| WeaponLeanYawRange        | 14.0          | How far the weapon can be pushed left/right by turning the camera right/left (higher value = further left/right).                                                                                                                                                          |
| WeaponLeanDistRange       | 34.0          | How far the weapon can be pushed down by approaching an obstacle (higher value = further down).                                                                                                                                                                            |
| Weapon3DLeanPitchRangeMin | -6.0          | 3D weapons only: How far the weapon can be pushed UP by when moving the camera DOWN (has to be <= 0.0; lower value = further up).                                                                                                                                          |
| Weapon3DLeanPitchRangeMax | 6.0           | 3D weapons only: How far the weapon can be pushed DOWN by when moving the camera UP (has to be >= 0.0; higher value = further down).                                                                                                                                       |
| Weapon3DLeanYawRange      | 9.0           | 3D weapons only: How far the weapon can be pushed left/right by turning the camera right/left (higher value = further left/right).                                                                                                                                         |
| Weapon3DLeanDistRange     | 34.0          | 3D weapons only: How far the weapon can be pushed down by approaching an obstacle (lower value = further down).                                                                                                                                                            |
